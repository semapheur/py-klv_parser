...
@UASLocalMetadataSet.add_parser
class PrecisionTimeStamp(DateTimeTagParser):
...
@UASLocalMetadataSet.add_parser
class MissionID(StringTagParser):
...
@UASLocalMetadataSet.add_parser
class PlatformTailNumber(StringTagParser):
  key = b"\x04"
  TAG = 4
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class PlatformHeadingAngle(MappedTagParser):
  key = b"\x05"
  TAG = 5
...
@UASLocalMetadataSet.add_parser
class PlatformPitchAngle(MappedTagParser):
  key = b"\x06"
  TAG = 6
...
@UASLocalMetadataSet.add_parser
class PlatformRollAngle(MappedTagParser):
  key = b"\x07"
  TAG = 7
...
@UASLocalMetadataSet.add_parser
class PlatformTrueAirspeed(MappedTagParser):
  key = b"\x08"
  TAG = 8
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class PlatformIndicatedAirspeed(MappedTagParser):
  key = b"\x09"
  TAG = 9
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class PlatformDesignation(StringTagParser):
  key = b"\x0a"
  TAG = 10
...
@UASLocalMetadataSet.add_parser
class ImageSourceSensor(StringTagParser):
  key = b"\x0b"
  TAG = 11
...
@UASLocalMetadataSet.add_parser
class ImageCoordinateSystem(StringTagParser):
  key = b"\x0c"
  TAG = 12
...
@UASLocalMetadataSet.add_parser
class SensorLatitude(MappedTagParser):
  key = b"\x0d"
  TAG = 13
...
@UASLocalMetadataSet.add_parser
class SensorLongitude(MappedTagParser):
  key = b"\x0e"
  TAG = 14
...
@UASLocalMetadataSet.add_parser
class SensorTrueAltitude(MappedTagParser):
  key = b"\x0f"
  TAG = 15
...
@UASLocalMetadataSet.add_parser
class SensorHorizontalFieldOfView(MappedTagParser):
  key = b"\x10"
  TAG = 16
...
@UASLocalMetadataSet.add_parser
class SensorVerticalFieldOfView(MappedTagParser):
  key = b"\x11"
  TAG = 17
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class SensorRelativeAzimuthAngle(MappedTagParser):
  key = b"\x12"
  TAG = 18
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class SensorRelativeElevationAngle(MappedTagParser):
  key = b"\x13"
  TAG = 19
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class SensorRelativeRollAngle(MappedTagParser):
  key = b"\x14"
  TAG = 20
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class SlantRange(MappedTagParser):
  key = b"\x15"
  TAG = 21
...
@UASLocalMetadataSet.add_parser
class TargetWidth(MappedTagParser):
  key = b"\x16"
  TAG = 22
...
@UASLocalMetadataSet.add_parser
class FrameCenterLatitude(MappedTagParser):
  key = b"\x17"
  TAG = 23
...
@UASLocalMetadataSet.add_parser
class FrameCenterLongitude(MappedTagParser):
  key = b"\x18"
  TAG = 24
...
@UASLocalMetadataSet.add_parser
class FrameCenterElevation(MappedTagParser):
  key = b"\x19"
  TAG = 25
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class OffsetCornerLatitudePoint1(MappedTagParser):
  key = b"\x1a"
  TAG = 26
...
@UASLocalMetadataSet.add_parser
class OffsetCornerLongitudePoint1(MappedTagParser):
  key = b"\x1b"
  TAG = 27
...
@UASLocalMetadataSet.add_parser
class OffsetCornerLatitudePoint2(MappedTagParser):
  key = b"\x1c"
  TAG = 28
...
@UASLocalMetadataSet.add_parser
class OffsetCornerLongitudePoint2(MappedTagParser):
  key = b"\x1d"
  TAG = 29
...
@UASLocalMetadataSet.add_parser
class OffsetCornerLatitudePoint3(MappedTagParser):
  key = b"\x1e"
  TAG = 30
...
@UASLocalMetadataSet.add_parser
class OffsetCornerLongitudePoint3(MappedTagParser):
  key = b"\x1f"
  TAG = 31
...
@UASLocalMetadataSet.add_parser
class OffsetCornerLatitudePoint4(MappedTagParser):
  key = b"\x20"
  TAG = 32
...
@UASLocalMetadataSet.add_parser
class OffsetCornerLongitudePoint4(MappedTagParser):
  key = b"\x21"
  TAG = 33
...
@UASLocalMetadataSet.add_parser
class IcingDetected(MappedTagParser):
  key = b"\x22"
  TAG = 34
  UDSKey = ""
...
@UASLocalMetadataSet.add_parser
class WindDirection(MappedTagParser):
  key = b"\x23"
  TAG = 35
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class WindSpeed(MappedTagParser):
  key = b"\x24"
  TAG = 36
  UDSKey = "-"
  LDSName = "Wind Speed"
...
@UASLocalMetadataSet.add_parser
class StaticPressure(MappedTagParser):
  key = b"\x25"
  TAG = 37
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class DensityAltitude(MappedTagParser):
  key = b"\x26"
  TAG = 38
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class OutsideAirTemperature(MappedTagParser):
  key = b"\x27"
  TAG = 39
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class TargetLocationLatitude(MappedTagParser):
  key = b"\x28"
  TAG = 40
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class TargetLocationLongitude(MappedTagParser):
  key = b"\x29"
  TAG = 41
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class TargetLocationElevation(MappedTagParser):
  key = b"\x2a"
  TAG = 42
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class TargetTrackGateWidth(MappedTagParser):
  key = b"\x2b"
  TAG = 43
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class TargetTrackGateHeight(MappedTagParser):
  key = b"\x2c"
  TAG = 44
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class TargetErrorEstimateCE90(MappedTagParser):
  key = b"\x2d"
  TAG = 45
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class TargetErrorEstimateLE90(MappedTagParser):
  key = b"\x2e"
  TAG = 46
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class GenericFlagData01(MappedTagParser):
  key = b"\x2f"
  TAG = 47
  UDSKey = "-"
...
# @UASLocalMetadataSet.add_parser
# class SecurityLocalMetadataSet(MappedTagParser):
#     key = b'\x30'
#     TAG = 48
...
@UASLocalMetadataSet.add_parser
class DifferentialPressure(MappedTagParser):
  key = b"\x31"
  TAG = 49
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class PlatformAngleOfAttack(MappedTagParser):
  key = b"\x32"
  TAG = 50
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class PlatformVerticalSpeed(MappedTagParser):
  key = b"\x33"
  TAG = 51
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class PlatformSideslipAngle(MappedTagParser):
  key = b"\x34"
  TAG = 52
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class AirfieldBarometricPressure(MappedTagParser):
  key = b"\x35"
  TAG = 53
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class AirfieldElevation(MappedTagParser):
  key = b"\x36"
  TAG = 54
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class RelativeHumidity(MappedTagParser):
  key = b"\x37"
  TAG = 55
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class PlatformGroundSpeed(MappedTagParser):
  key = b"\x38"
  TAG = 56
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class GroundRange(MappedTagParser):
  key = b"\x39"
  TAG = 57
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class PlatformFuelRemaining(MappedTagParser):
  key = b"\x3a"
  TAG = 58
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class PlatformCallSign(StringTagParser):
  key = b"\x3b"
  TAG = 59
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class WeaponLoad(MappedTagParser):
  key = b"\x3c"
  TAG = 60
  UDSKey = "-"
  LDSName = "Weapon Load"
...
@UASLocalMetadataSet.add_parser
class WeaponFired(MappedTagParser):
  key = b"\x3d"
  TAG = 61
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class LaserPRFCode(MappedTagParser):
  key = b"\x3e"
  TAG = 62
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class SensorFieldOfViewName(MappedTagParser):
  key = b"\x3f"
  TAG = 63
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class PlatformMagneticHeading(MappedTagParser):
  key = b"\x40"
  TAG = 64
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class UASLSVersionNumber(MappedTagParser):
  key = b"\x41"
  TAG = 65
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class AlternatePlatformLatitude(MappedTagParser):
  key = b"\x43"
  TAG = 67
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class AlternatePlatformLongitude(MappedTagParser):
  key = b"\x44"
  TAG = 68
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class AlternatePlatformAltitude(MappedTagParser):
  key = b"\x45"
  TAG = 69
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class AlternatePlatformName(StringTagParser):
  key = b"\x46"
  TAG = 70
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class AlternatePlatformHeading(MappedTagParser):
  key = b"\x47"
  TAG = 71
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class EventStartTime(DateTimeTagParser):
  key = b"\x48"
  TAG = 72
...
@UASLocalMetadataSet.add_parser
class RVTLocalSet(MappedTagParser):
  key = b"\x49"
  TAG = 73
  UDSKey = "06 0E 2B 34 01 01 01 01 07 02 01 02 07 01 00 00"
...
@UASLocalMetadataSet.add_parser
class VMTILocalSet(StringTagParser):
  key = b"\x4a"
  TAG = 74
...
@UASLocalMetadataSet.add_parser
class SensorEllipsoidHeightConversion(MappedTagParser):
  key = b"\x4b"
  TAG = 75
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class AlternatePlatformEllipsoidHeight(MappedTagParser):
  key = b"\x4c"
  TAG = 76
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class OperationalMode(StringTagParser):
  key = b"\x4d"
  TAG = 77
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class FrameCenterHeightAboveEllipsoid(MappedTagParser):
  key = b"\x4e"
  TAG = 78
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class SensorNorthVelocity(MappedTagParser):
  key = b"\x4f"
  TAG = 79
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class SensorEastVelocity(MappedTagParser):
  key = b"\x50"
  TAG = 80
  UDSKey = "-"
...
# @UASLocalMetadataSet.add_parser
# class ImageHorizonPixelPack(MappedTagParser):
#     key = b'\x51'
#     TAG = 81
#     UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class CornerLatitudePoint1Full(MappedTagParser):
  key = b"\x52"
  TAG = 82
  UDSKey = "06 0E 2B 34 01 01 01 03 07 01 02 01 03 07 01 00"
...
@UASLocalMetadataSet.add_parser
class CornerLongitudePoint1Full(MappedTagParser):
  key = b"\x53"
  TAG = 83
  UDSKey = "06 0E 2B 34 01 01 01 03 07 01 02 01 03 0B 01 00"
...
@UASLocalMetadataSet.add_parser
class CornerLatitudePoint2Full(MappedTagParser):
  key = b"\x54"
  TAG = 84
  UDSKey = "06 0E 2B 34 01 01 01 03 07 01 02 01 03 08 01 00"
...
@UASLocalMetadataSet.add_parser
class CornerLongitudePoint2Full(MappedTagParser):
  key = b"\x55"
  TAG = 85
  UDSKey = "06 0E 2B 34 01 01 01 03 07 01 02 01 03 0C 01 00"
...
@UASLocalMetadataSet.add_parser
class CornerLatitudePoint3Full(MappedTagParser):
  key = b"\x56"
  TAG = 86
  UDSKey = "06 0E 2B 34 01 01 01 03 07 01 02 01 03 09 01 00"
...
@UASLocalMetadataSet.add_parser
class CornerLongitudePoint3Full(MappedTagParser):
  key = b"\x57"
  TAG = 87
  UDSKey = "06 0E 2B 34 01 01 01 03 07 01 02 01 03 0D 01 00"
...
@UASLocalMetadataSet.add_parser
class CornerLatitudePoint4Full(MappedTagParser):
  key = b"\x58"
  TAG = 88
  UDSKey = "06 0E 2B 34 01 01 01 03 07 01 02 01 03 0A 01 00"
...
@UASLocalMetadataSet.add_parser
class CornerLongitudePoint4Full(MappedTagParser):
  key = b"\x59"
  TAG = 89
  UDSKey = "06 0E 2B 34 01 01 01 03 07 01 02 01 03 0E 01 00"
...
@UASLocalMetadataSet.add_parser
class PlatformPitchAngleFull(MappedTagParser):
  key = b"\x5a"
  TAG = 90
  UDSKey = "06 0E 2B 34 01 01 01 07 07 01 10 01 05 00 00 00"
...
@UASLocalMetadataSet.add_parser
class PlatformRollAngleFull(MappedTagParser):
  key = b"\x5b"
  TAG = 91
  UDSKey = "06 0E 2B 34 01 01 01 07 07 01 10 01 04 00 00 00"
...
@UASLocalMetadataSet.add_parser
class PlatformAngleOfAttackFull(MappedTagParser):
  key = b"\x5c"
  TAG = 92
  UDSKey = "-"
...
@UASLocalMetadataSet.add_parser
class PlatformSideslipAngleFull(MappedTagParser):
  key = b"\x5d"
  TAG = 93
  UDSKey = "-"
...
# @UASLocalMetadataSet.add_parser
# class MIISCoreIdentifier(StringTagParser):
#     key = b'\x5E'
#     TAG = 94
...
# @UASLocalMetadataSet.add_parser
# class SARMotionImageryLocalSet(StringTagParser):
#     key = b'\x5F'
#     TAG = 95
...
@UASLocalMetadataSet.add_parser
class TargetWidthExtended(MappedTagParser):
  key = b"\x60"
  TAG = 96
  UDSKey = "06 0E 2B 34 01 01 01 01 07 01 09 02 01 00 00 00"
...
@UASLocalMetadataSet.add_parser
class DensityAltitudeExtended(MappedTagParser):
  key = b"\x67"
  TAG = 103
...
@UASLocalMetadataSet.add_parser
class SensorEllipsoidHeightExtended(MappedTagParser):
  key = b"\x68"
  TAG = 104
...
@UASLocalMetadataSet.add_parser
class AlternatePlatformEllipsoidHeightExtended(MappedTagParser):
  key = b"\x69"
  TAG = 105
